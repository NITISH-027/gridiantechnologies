  ...
  return (
    <section id="contact" className="py-24 bg-[#F9F9F9]">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.a
                href="mailto:hello@gridiantech.com"
        ...
        >
          {[
            { icon: Mail, label: "Email Us", value: "hello@gridiantech.com" },
            { icon: Phone, label: "Call Us", value: "+1 (800) 555-0199" },
            { icon: MapPin, label: "Location", value: "San Francisco, CA · Remote" },
