...
const stats = [
  { value: "150+", label: "Projects Delivered", sub: "across 15+ industries" },
  { value: "98%", label: "Client Satisfaction", sub: "measured post-launch" },
  { value: "28", label: "Countries Served", sub: "global reach" },
  { value: "12+", label: "Years of Expertise", sub: "since 2012" },
  { value: "50+", label: "Team Members", sub: "engineers & designers" },
