        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-neutral-500 text-base leading-relaxed mb-10">
              ...
              millions across 28 countries. Our process is transparent, our code is clean, and our
          ...
          >
            ...
            <div className="rounded-3xl bg-[#F9F9F9] p-6 flex flex-col justify-between min-h-[140px]">
              ...
              <div>
                <p className="text-4xl font-bold text-neutral-900">2012</p>
                <p className="text-sm text-neutral-500 mt-1">12+ years of excellence</p>
              </div>
            </div>
            ...
            <div className="rounded-3xl bg-cobalt-50 p-6 flex flex-col justify-between min-h-[140px]">
              ...
              <div>
                <p className="text-4xl font-bold text-cobalt-500">50+</p>
